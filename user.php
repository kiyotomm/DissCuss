...
<div class="flex flex-col items-center justify-center w-screen h-[60vh] x">
    <div class="flex gap-7 flex-col font-bold text-3xl rounded-lg shadow-xl p-[5vw]">
        ...
        <div class="flex gap-[8vw]"><span>Password:</span><?php echo $_SESSION['user']['password'] ?></div>
